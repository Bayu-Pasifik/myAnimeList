...
// ! function untuk index manga
  void indexManga(String letter, int hal) async {
    Uri url = Uri.parse(
        'https://api.jikan.moe/v4/manga?letter=$letter&page=$hal&order_by=title&sort=asc&sfw=false&genres_exclude=12,42,28');
  ...
  // Future<List<manga.Manga>> indexManga(String letter, int hal) async {
  //   Uri url = Uri.parse(
  ...
  //     List<manga.Manga> listManga = List<manga.Manga>.from(tempmangaList);
  //     if (letter == "A") {
  //       mangaIndexA.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       final isLastPage = page['has_next_page'] == false;
  //       if (isLastPage) {
  //         Get.snackbar("Error", "No more data");
  //         allmangaController.appendLastPage(mangaIndexA);
  //       } else {
  //         allmangaController.appendPage(mangaIndexA, hal + 1);
  //       }
  //       return listManga;
  //     } else if (letter == "B") {
  //       mangaIndexB.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "C") {
  //       mangaIndexC.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "D") {
  //       mangaIndexD.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "E") {
  //       mangaIndexE.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "F") {
  //       mangaIndexF.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "G") {
  //       mangaIndexG.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "H") {
  //       mangaIndexH.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "I") {
  //       mangaIndexI.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "J") {
  //       mangaIndexJ.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "K") {
  //       mangaIndexK.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "L") {
  //       mangaIndexL.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "M") {
  //       mangaIndexM.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "N") {
  //       mangaIndexN.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "O") {
  //       mangaIndexO.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "P") {
  //       mangaIndexP.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "Q") {
  //       mangaIndexQ.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "R") {
  //       mangaIndexR.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "S") {
  //       mangaIndexS.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "T") {
  //       mangaIndexT.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "U") {
  //       mangaIndexU.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "V") {
  //       mangaIndexV.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "W") {
  //       mangaIndexW.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "X") {
  //       mangaIndexX.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "Y") {
  //       mangaIndexY.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     } else if (letter == "Z") {
  //       mangaIndexZ.addAll(listManga);
  //       update();
  //       page = data["pagination"];
  //       return listManga;
  //     }
  ...
  // List<manga.Manga> getMangaIndex(String index) {
  //   switch (index) {
  //     case 'A':
  //       return mangaIndexA;
  //     case 'B':
  //       return mangaIndexB;
  //     // ... tambahkan case untuk indeks lain sesuai kebutuhan Anda
  //     case 'Z':
  //       return mangaIndexZ;
  //     default:
  //       return [];
...
// ! fungsi load data index
  ...
  //       return;
  //   }
  //   print("Refresh state ${refreshController.initialRefresh}");
  //   if (refreshController.isRefresh ||
  //       refreshController.initialRefresh == true) {
  //     mangaIndexA.clear();
  //     print("panjang A ${mangaIndexA.length}");
  //     currentPage = 1;
