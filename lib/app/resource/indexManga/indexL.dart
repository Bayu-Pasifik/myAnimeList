...
GetBuilder<HomeMangaController> mangaByIndexL(HomeMangaController controller) {
  return GetBuilder<HomeMangaController>(
    builder: (c) {
      return SmartRefresher(
          controller: c.refreshControllerL,
          enablePullDown: true,
          enablePullUp: true,
          onLoading: () => c.loadData("L"),
          onRefresh: () => c.refreshData("L"),
          footer: CustomFooter(
          ...
          child: GridView.builder(
            ...
            itemCount: c.mangaIndexL.length,
            ...
            itemBuilder: (context, index) {
              manga.Manga mangas = c.mangaIndexL[index];
