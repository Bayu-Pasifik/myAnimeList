...
GetBuilder<HomeMangaController> mangaByIndexS(HomeMangaController controller) {
  return GetBuilder<HomeMangaController>(
    builder: (c) {
      return SmartRefresher(
          controller: c.refreshControllerS,
          enablePullDown: true,
          enablePullUp: true,
          onLoading: () => c.loadData("S"),
          onRefresh: () => c.refreshData("S"),
          footer: CustomFooter(
          ...
          child: GridView.builder(
            ...
            itemCount: c.mangaIndexS.length,
            ...
            itemBuilder: (context, index) {
              manga.Manga mangas = c.mangaIndexS[index];
