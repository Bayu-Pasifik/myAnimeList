...
GetBuilder<HomeMangaController> mangaByIndexZ(HomeMangaController controller) {
  return GetBuilder<HomeMangaController>(
    builder: (c) {
      return SmartRefresher(
          controller: c.refreshControllerZ,
          enablePullDown: true,
          enablePullUp: true,
          onLoading: () => c.loadData("Z"),
          onRefresh: () => c.refreshData("Z"),
          footer: CustomFooter(
          ...
          child: GridView.builder(
            ...
            itemCount: c.mangaIndexZ.length,
            ...
            itemBuilder: (context, index) {
              manga.Manga mangas = c.mangaIndexZ[index];
