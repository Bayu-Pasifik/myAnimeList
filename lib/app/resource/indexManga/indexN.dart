...
GetBuilder<HomeMangaController> mangaByIndexN(HomeMangaController controller) {
  return GetBuilder<HomeMangaController>(
    builder: (c) {
      return SmartRefresher(
          controller: c.refreshControllerN,
          enablePullDown: true,
          enablePullUp: true,
          onLoading: () => c.loadData("N"),
          onRefresh: () => c.refreshData("N"),
          footer: CustomFooter(
          ...
          child: GridView.builder(
            ...
            itemCount: c.mangaIndexN.length,
            ...
            itemBuilder: (context, index) {
              manga.Manga mangas = c.mangaIndexN[index];
