...
GetBuilder<HomeMangaController> mangaByIndexC(HomeMangaController controller) {
  return GetBuilder<HomeMangaController>(
    builder: (c) {
      return SmartRefresher(
          controller: c.refreshControllerC,
          enablePullDown: true,
          enablePullUp: true,
          onLoading: () => c.loadData("C"),
          onRefresh: () => c.refreshData("C"),
          footer: CustomFooter(
          ...
          child: GridView.builder(
            ...
            itemCount: c.mangaIndexC.length,
