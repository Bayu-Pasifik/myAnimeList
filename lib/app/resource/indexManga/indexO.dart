...
GetBuilder<HomeMangaController> mangaByIndexO(HomeMangaController controller) {
  return GetBuilder<HomeMangaController>(
    builder: (c) {
      return SmartRefresher(
          controller: c.refreshControllerO,
          enablePullDown: true,
          enablePullUp: true,
          onLoading: () => c.loadData("O"),
          onRefresh: () => c.refreshData("O"),
          footer: CustomFooter(
          ...
          child: GridView.builder(
            ...
            itemCount: c.mangaIndexO.length,
            ...
            itemBuilder: (context, index) {
              manga.Manga mangas = c.mangaIndexO[index];
