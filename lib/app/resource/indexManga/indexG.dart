...
GetBuilder<HomeMangaController> mangaByIndexG(HomeMangaController controller) {
  return GetBuilder<HomeMangaController>(
    builder: (c) {
      return SmartRefresher(
          controller: c.refreshControllerG,
          enablePullDown: true,
          enablePullUp: true,
          onLoading: () => c.loadData("G"),
          onRefresh: () => c.refreshData("G"),
          footer: CustomFooter(
          ...
          child: GridView.builder(
            ...
            itemCount: c.mangaIndexG.length,
            ...
            itemBuilder: (context, index) {
              manga.Manga mangas = c.mangaIndexG[index];
