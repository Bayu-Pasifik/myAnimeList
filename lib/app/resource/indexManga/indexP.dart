...
GetBuilder<HomeMangaController> mangaByIndexP(HomeMangaController controller) {
  return GetBuilder<HomeMangaController>(
    builder: (c) {
      return SmartRefresher(
          controller: c.refreshControllerP,
          enablePullDown: true,
          enablePullUp: true,
          onLoading: () => c.loadData("P"),
          onRefresh: () => c.refreshData("P"),
          footer: CustomFooter(
          ...
          child: GridView.builder(
            ...
            itemCount: c.mangaIndexP.length,
            ...
            itemBuilder: (context, index) {
              manga.Manga mangas = c.mangaIndexP[index];
