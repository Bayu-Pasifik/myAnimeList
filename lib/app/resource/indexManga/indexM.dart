...
GetBuilder<HomeMangaController> mangaByIndexM(HomeMangaController controller) {
  return GetBuilder<HomeMangaController>(
    builder: (c) {
      return SmartRefresher(
          controller: c.refreshControllerM,
          enablePullDown: true,
          enablePullUp: true,
          onLoading: () => c.loadData("M"),
          onRefresh: () => c.refreshData("M"),
          footer: CustomFooter(
          ...
          child: GridView.builder(
            ...
            itemCount: c.mangaIndexM.length,
            ...
            itemBuilder: (context, index) {
              manga.Manga mangas = c.mangaIndexM[index];
