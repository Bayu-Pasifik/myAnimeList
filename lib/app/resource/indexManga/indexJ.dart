...
GetBuilder<HomeMangaController> mangaByIndexJ(HomeMangaController controller) {
  return GetBuilder<HomeMangaController>(
    builder: (c) {
      return SmartRefresher(
          controller: c.refreshControllerJ,
          enablePullDown: true,
          enablePullUp: true,
          onLoading: () => c.loadData("J"),
          onRefresh: () => c.refreshData("J"),
          footer: CustomFooter(
          ...
          child: GridView.builder(
            ...
            itemCount: c.mangaIndexJ.length,
            ...
            itemBuilder: (context, index) {
              manga.Manga mangas = c.mangaIndexJ[index];
