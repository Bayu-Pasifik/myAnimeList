...
GetBuilder<HomeMangaController> mangaByIndexH(HomeMangaController controller) {
  return GetBuilder<HomeMangaController>(
    builder: (c) {
      return SmartRefresher(
          controller: c.refreshControllerH,
          enablePullDown: true,
          enablePullUp: true,
          onLoading: () => c.loadData("H"),
          onRefresh: () => c.refreshData("H"),
          footer: CustomFooter(
          ...
          child: GridView.builder(
            ...
            itemCount: c.mangaIndexH.length,
            ...
            itemBuilder: (context, index) {
             manga.Manga mangas = c.mangaIndexH[index];
