...
GetBuilder<HomeMangaController> mangaByIndexD(HomeMangaController controller) {
  return GetBuilder<HomeMangaController>(
    builder: (c) {
      return SmartRefresher(
          controller: c.refreshControllerD,
          enablePullDown: true,
          enablePullUp: true,
          onLoading: () => c.loadData("D"),
          onRefresh: () => c.refreshData("D"),
          footer: CustomFooter(
          ...
          child: GridView.builder(
            ...
            itemCount: c.mangaIndexD.length,
            ...
            itemBuilder: (context, index) {
              manga.Manga mangas = c.mangaIndexD[index];
