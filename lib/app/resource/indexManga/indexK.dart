...
GetBuilder<HomeMangaController> mangaByIndexK(HomeMangaController controller) {
  return GetBuilder<HomeMangaController>(
    builder: (c) {
      return SmartRefresher(
          controller: c.refreshControllerK,
          enablePullDown: true,
          enablePullUp: true,
          onLoading: () => c.loadData("K"),
          onRefresh: () => c.refreshData("K"),
          footer: CustomFooter(
          ...
          child: GridView.builder(
            ...
            itemCount: c.mangaIndexK.length,
            ...
            itemBuilder: (context, index) {
              manga.Manga mangas = c.mangaIndexK[index];
