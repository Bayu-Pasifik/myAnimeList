...
GetBuilder<HomeMangaController> mangaByIndexR(HomeMangaController controller) {
  return GetBuilder<HomeMangaController>(
    builder: (c) {
      return SmartRefresher(
          controller: c.refreshControllerR,
          enablePullDown: true,
          enablePullUp: true,
          onLoading: () => c.loadData("R"),
          onRefresh: () => c.refreshData("R"),
          footer: CustomFooter(
          ...
          child: GridView.builder(
            ...
            itemCount: c.mangaIndexR.length,
            ...
            itemBuilder: (context, index) {
              manga.Manga mangas = c.mangaIndexR[index];
              return GestureDetector(
                onTap: () {
                  Get.toNamed(Routes.DETAIL_SEARCH, arguments: mangas);
                },
                child: ClipRRect(
