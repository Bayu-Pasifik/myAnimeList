...
GetBuilder<HomeMangaController> mangaByIndexX(HomeMangaController controller) {
  return GetBuilder<HomeMangaController>(
    builder: (c) {
      return SmartRefresher(
          controller: c.refreshControllerX,
          enablePullDown: true,
          enablePullUp: true,
          onLoading: () => c.loadData("X"),
          onRefresh: () => c.refreshData("X"),
          footer: CustomFooter(
          ...
          child: GridView.builder(
            ...
            itemCount: c.mangaIndexX.length,
            ...
            itemBuilder: (context, index) {
              manga.Manga mangas = c.mangaIndexX[index];
              return ClipRRect(
