...
GetBuilder<HomeMangaController> mangaByIndexV(HomeMangaController controller) {
  return GetBuilder<HomeMangaController>(
    builder: (c) {
      return SmartRefresher(
          controller: c.refreshControllerV,
          enablePullDown: true,
          enablePullUp: true,
          onLoading: () => c.loadData("V"),
          onRefresh: () => c.refreshData("V"),
          footer: CustomFooter(
          ...
          child: GridView.builder(
            ...
            itemCount: c.mangaIndexV.length,
            ...
            itemBuilder: (context, index) {
              manga.Manga mangas = c.mangaIndexV[index];
